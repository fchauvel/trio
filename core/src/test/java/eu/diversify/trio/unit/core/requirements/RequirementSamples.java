 ...
 */
public class RequirementSamples {

    public static Require require() {
        return new Require("Y");
    }
    ...
    public static Conjunction conjunction() {
        return new Conjunction(new Require("X"), new Require("Y"));
    }

    public static Disjunction disjunction() {
        return new Disjunction(new Require("X"), new Require("Y")); 
    }
    
    public static Negation negation() {
        return new Negation(new Require("X"));
    }
