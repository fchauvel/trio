...
/**
 * RunAsThread a given command and collect the standard and error output
 */
public class RunAsThread implements Run {
    
    private final OutputCollector standardOutput;
    private final OutputCollector standardError;
    private final String[] commandLine;
   
    public RunAsThread(String directory, String[] arguments) throws IOException, InterruptedException {
