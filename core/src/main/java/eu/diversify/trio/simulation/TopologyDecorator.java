...
/**
 * Abstract decorator of topology
 */
public abstract class TopologyDecorator implements Topology {
    ...
    public boolean contains(String componentName) {
        return topology.contains(componentName);
    }
    ...
    public boolean hasActiveComponents() {
        return topology.hasActiveComponents();
    }

    public List<String> activeComponents() {
        return topology.activeComponents();
    }

    public Topology select(Filter selection) {
        return topology.select(selection);
    }
