...
import net.fchauvel.trio.simulation.events.IdleSimulationListener;
import net.fchauvel.trio.simulation.events.SimulationListener;
...
public class FailureSequenceAggregator {
    ...
    private final net.fchauvel.trio.analytics.events.StatisticListener statistics;
    private final Map<Integer, FailureSequence> sequences;
    private final SimulationHandler listener;
    
    public FailureSequenceAggregator(net.fchauvel.trio.analytics.events.StatisticListener statistics) {
