 ...
 * along with TRIO. If not, see <http://www.gnu.org/licenses/>.
 */
package net.fchauvel.trio.analytics.sensitivity;

/**
 * Captures a single entry in the ranking (the component and its sensitivity)
 */
public class Sensitivity implements Comparable<Sensitivity> {
    ...
    public void recordFailure(int impact) {
        assert impact >= 0 : "A failure impact must be positive or null (found " + impact + ")";
