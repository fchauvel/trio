...
public class Dispatcher extends DefaultAssemblyVisitor {
    ...
    public Dispatcher(List<AssemblyVisitor> listeners) {
        net.fchauvel.trio.util.Require.notNull(listeners, "Invalid 'null' value provided as listeners!");
        net.fchauvel.trio.util.Require.notEmpty(listeners, "Invalid empty list [] provided as listeners!");
