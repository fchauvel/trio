...
package net.fchauvel.trio.core.requirements;

import net.fchauvel.trio.core.AssemblyPart;
...
public class Require extends Requirement {
    ...
    public Require(String requiredComponent) {
        net.fchauvel.trio.util.Require.notNull(requiredComponent, "'null' given as required component name!");
